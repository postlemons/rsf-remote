...
from .processing import fetch_google_sheets, filter_and_remove_matches, local_file_to_df
...
def index():
    ...
    if request.method == "POST":
        try:
           ...
           # sheet_ranges = request.form.getlist('["BETA", "Responses 2"]')  # Get all sheet ranges as a list
            sheet_ranges = ["BETA", "Responses 2"] # come back here to review it later 
            print(sheet_ranges)
